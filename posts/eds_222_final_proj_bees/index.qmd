...
![](bee_pesticide_map.png "Bee Pesticide Map"){fig-align="center"}
...
<figcaption>A demonstration of a small subset of the data within the USGS Land Cover Dataset. Cropland and grassland are common land types in Solano County, with development also being notable.</figcaption>
</br>
# Analysis Plan
...
<figcaption>Species richness and pesticide use are not coorelated upon initial inspection, as the R<sup>2</sup> is very low and p-value is above 0.10.</figcaption>
<br>
...
<figcaption>Demonstration of spatial autocorrelation. On top, Moran's I falls outside the range of the null distribution, while the residuals have a slight positive correlation with the spatial neighborhood. The bottom figures are plotted with a error model, remediating the autocorrelation.</figcaption>
</br>  
...
Because biodiversity and pesticide use was not significantly correlated, I want to add more variables to see if there is potentially omitted variable bias. I decided to add land cover to the model because of it's relation to habitat fragmentation. Land cover was added as a binary variable, in which the land types were classified into being habitat and non-habitat. Our new model is:
...
<figcaption>Pesticide used has been plotted against Biodiversity in a simple two variable linear model. The variables are not significant, but there is a slight negative slope.</figcaption>

</br>
![](land_cover_lm.png "Biodiversity Against Pesticide Use and Land Cover"){fig-align="center"}
<figcaption>Adding land use to the model, substantially increased the r<sup>2</sup> and made the p-value significant at p < 0.01.</figcaption>
</br>
